%% TO DO - DOCUMENT AND RENAME (STEVE)
...
% Bin the linguistic data based on whether a response was 'left' 'ahead' or
% 'right'
...
% Sort linguistic data and create behavioral RDMs
...
% Import the data
analogData = readtable(fullfile(dataDir,'drawingData_44614.csv'),'PreserveVariableNames',true);
analogData = analogData(:,2:end);

% Removing one datapoint that received all the same responses in the
...
% NOTE TO STEVE - CREATE FUNCTION TO DO THE BELOW
